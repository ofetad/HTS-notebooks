...
```
    ...
    ## drwxr-xr-x 2 guest users 4096 Jul 25 17:43 /tmp/RtmpW5axgN/rr_raw_data
    ## total 12
...
```
    ...
    ## rm: cannot remove '/tmp/RtmpW5axgN/rr_raw_data/mydata_md5.txt': Permission denied
